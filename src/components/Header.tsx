    ...
    <header className="bg-white/95 backdrop-blur-md sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          ...
          <a href="#how-it-works" className="text-travel-dark hover:text-travel-blue transition-colors">How It Works</a>
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 right-0 bg-white shadow-md animate-fade-in z-40">
          <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
            <a 
              href="#features" 
              className="text-travel-dark hover:text-travel-blue transition-colors py-2 px-4"
              onClick={toggleMenu}
            >
              Features
            </a>
            ...
            <Button 
              className="bg-travel-blue hover:bg-travel-teal text-white transition-colors w-full"
              onClick={() => {
                toggleMenu();
