          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-travel-light rounded-xl p-8 text-center relative">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-travel-green text-white h-8 w-8 rounded-full flex items-center justify-center">
                  1
                </div>
                <MapPin className="h-12 w-12 text-travel-green mx-auto mb-4" />
              ...
              <div className="bg-travel-light rounded-xl p-8 text-center relative">
                ...
                <MessageCircle className="h-12 w-12 text-travel-green mx-auto mb-4" />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <div className="flex justify-center mt-6">
                <ArrowDown className="h-8 w-8 text-travel-green animate-bounce" />
              </div>
            </div>
